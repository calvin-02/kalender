...
**Adresse:** <https://calvin-02.github.io/tagwerk/>

## Wofür das gebaut ist

Ein Trainingsplan zeigt drei Krafttage. Die Läufe stehen nirgends, also finden sie nicht statt.
Tagwerk führt beides in einer Liste und **trennt die Zähler**: `Kraft 3/3` neben `Lauf 0/2`.
Was fehlt, ist dann nicht wegzuschauen.

Vier Kategorien, jede mit eigener Farbe und eigenem Zähler:
...
| Uni & Privat | Magenta | Vorlesungen, Klausuren, Termine — mit Uhrzeit |

Die Farben folgen der Okabe-Ito-Palette und bleiben bei Rot-Grün-Sehschwäche unterscheidbar.
...
Danach in `sw.js` die Zeile `const FASSUNG = "tagwerk-x.y.z"` hochzählen **und** in
